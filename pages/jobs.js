	...
	return (
		<MainLayout props={props} className={"isfixed"}>
			...
			<div className="container__jobs-content">
				...
				<p>
					{" "}
          Beer, valais, mountains, sensations, good products? Hm... probably...
          But what really brings us together is passion! Yes, the WhiteFrontier
          team is a group of young explorers, passionate about life. That Why,
          the production, the office or the taproom team make WhiteFrontier
          grow.{" "}
				</p>
