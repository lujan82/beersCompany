      ...
      <div className="detail-page">
        ...
        {beer !== undefined &&
          <div className="beer-detail">
            <div className="beer-detail__img" /* style={{ background: `url(${myBeer.url})` }} */ >
              {beer?.url &&
                <img src={beer.url} alt="" />
              }
            </div>

            <div className="beer-detail__content" style={{ backgroundColor: background }}>
              <div>

                <div className="beer-detail__name">{ beer?.name && beer.name}</div>

                <div className="beer-detail__description-container">
                  <div className="beer-detail__description-title">Description</div>
                  <div className="beer-detail__description-text">
                    <p> { beer?.description } </p>
                    <p> <strong>Ingredients :</strong> {beer?.ingredients} </p>
                  </div>
                </div>
